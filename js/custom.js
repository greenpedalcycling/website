        ...
        jQuery.ajax({
          ...
          success: function (data) {
            if (data.success) {
              ...
              jQuery(".msg").addClass("alert alert-success alert-dismissible");
              jQuery(".msg").text("Thank You, Your Message Has been Sent");
            } else {
              jQuery(".msg").removeClass(
                "alert alert-success alert-dismissible"
              );
              jQuery(".msg").addClass("alert alert-danger alert-dismissible");
              jQuery(".msg").text("Error on Sending Message, Please Try Again");
            }
          },
          error: function (error) {
            jQuery(".msg").removeClass("alert alert-success alert-dismissible");
            jQuery(".msg").addClass("alert alert-danger alert-dismissible");
